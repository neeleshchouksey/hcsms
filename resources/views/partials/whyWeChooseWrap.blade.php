                            ...
                            <div class="panel-group" id="accordionFifteenLeft" role="tablist">
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading horn">
                                        <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionFifteenLeft" href="#collapseFifteenLeftTwo" aria-expanded="false">- Multiple Languages</a>
                                                </h4>
                                    </div>
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionFifteenLeft" href="#collapseFifteenLeftThree" aria-expanded="false">- SMS Reminders with no need for an App</a>
                                                </h4>
                                    </div>
                                    <div id="collapseFifteenLeftThree" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>
                                                    We us SMS because it is the proven to be the most reliable method to contact patients.  
                                                    There is no App needed and patients do not need a smart phone, data signal or data allowance.  
                                                    SMS will reach any mobile phone, anywhere in the world, even if their signal is low.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionFifteenLeft" href="#collapseFifteenLeftFour" aria-expanded="false">- Smart Communications</a>
                                                </h4>
                                    </div>
                                    <div id="collapseFifteenLeftFour" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>
                                                    We include smart links to share letters and results, plus we track if a patient clicks the link.  
                                                    If so this is logged, if not we can follow up with a new SMS, Email or Letter automatically.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="panel panel-default sidebar_pannel">
                                    <div class="panel-heading bell">
                                        <h4 class="panel-title">
                                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionFifteenLeft" href="#collapseFifteenLeftfive" aria-expanded="false">- Medic Comm SMS</a>
                                                </h4>
                                    </div>
                                    <div id="collapseFifteenLeftfive" class="panel-collapse collapse" aria-expanded="false" style="height: 0px;" role="tabpanel">
                                        <div class="panel-body">
                                            <div class="panel_cont">
                                                <p>
                                                    We use SMS by default as it is fast, secure and reliable.  
                                                    An SMS is delivered in around 5 seconds and most are read within minutes.  
                                                    Most people keep the mobile number for many years or life.
                                                    People move home, travel and commute, so letters may be delivered but they can go unread for days, weeks or forever.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
